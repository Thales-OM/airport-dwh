...
INSERT INTO dwh_detailed.Sat_Airports (Airport_HK, Airport_Name, City, Coordinates_Lon, Coordinates_Lat, Timezone, Load_DTS, Record_Source, Effective_From, Effective_To) VALUES
(md5('JFK')::UUID, 'John F. Kennedy International Airport', 'New York', -73.7781, 40.6413, 'America/New_York', CURRENT_TIMESTAMP, 'postgres_master', CURRENT_TIMESTAMP, NULL),
(md5('LAX')::UUID, 'Los Angeles International Airport', 'Los Angeles', -118.4085, 33.9425, 'America/Los_Angeles', CURRENT_TIMESTAMP, 'postgres_master', CURRENT_TIMESTAMP, NULL),
(md5('ORD')::UUID, 'Hare International Airport', 'Chicago', -87.9048, 41.9742, 'America/Chicago', CURRENT_TIMESTAMP, 'postgres_master', CURRENT_TIMESTAMP, NULL),
(md5('ATL')::UUID, 'Hartsfield-Jackson Atlanta International Airport', 'Atlanta', -84.4279, 33.6407, 'America/New_York', CURRENT_TIMESTAMP, 'postgres_master', CURRENT_TIMESTAMP, NULL),
(md5('DFW')::UUID, 'Dallas/Fort Worth International Airport', 'Dallas', -97.0379, 32.8968, 'America/Chicago', CURRENT_TIMESTAMP, 'postgres_master', CURRENT_TIMESTAMP, NULL);

-- Insert mock data into Sat_Aircrafts
INSERT INTO dwh_detailed.Sat_Aircrafts (Aircraft_HK, Model, Range, Load_DTS, Record_Source, Effective_From, Effective_To) VALUES
(md5('A32')::UUID, '{"manufacturer": "Airbus", "model": "A32", "capacity": 180}', 3000, CURRENT_TIMESTAMP, 'postgres_master', CURRENT_TIMESTAMP, NULL),
(md5('B73')::UUID, '{"manufacturer": "Boeing", "model": "737", "capacity": 200}', 2900, CURRENT_TIMESTAMP, 'postgres_master', CURRENT_TIMESTAMP, NULL),
(md5('A38')::UUID, '{"manufacturer": "Airbus", "model": "A38", "capacity": 500}', 8000, CURRENT_TIMESTAMP, 'postgres_master', CURRENT_TIMESTAMP, NULL),
(md5('B74')::UUID, '{"manufacturer": "Boeing", "model": "747", "capacity": 400}', 8000, CURRENT_TIMESTAMP, 'postgres_master', CURRENT_TIMESTAMP, NULL),
(md5('B77')::UUID, '{"manufacturer": "Boeing", "model": "777", "capacity": 300}', 6000, CURRENT_TIMESTAMP, 'postgres_master', CURRENT_TIMESTAMP, NULL);
